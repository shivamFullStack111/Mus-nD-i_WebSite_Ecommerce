  ...
  return (
    <div className="h-[100vh] ">
      ...
      {width < 1200 && sideBarOpen && (
        <div className="min-w-[370px] absolute z-40 h-[100vh] top-0 bg-[#081028] left-0 w-[370px]  overflow-y-scroll hidden-scrollbar  border-r-4 border-slate-800 p-6">
          <RxCross1
          ...
          <tbody>
            {products.map((product, index) => (
              <tr key={index} className="hover:bg-[#0004] ">
                ...
                <td className="border border-gray-300 800px:px-4 px-6 py-2 800px:py-2">
                  <div className="bg-yellow-500 m-1 cursor-pointer inline text-white px-2 py-1 rounded mr-2 hover:bg-yellow-600 transition duration-200">
                    Edit
                  </div>
                  <button className="bg-red-500 text-white m-1 px-2 py-1 rounded hover:bg-red-600 transition duration-200">
                    Delete
                  </button>
                </td>
              </tr>
